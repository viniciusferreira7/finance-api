...
import { makeCreateExpenseUseCase } from '@/use-cases/factories/expenses/make-create-expense'
...
export const expenseSchemaBodyToJson = zodToJsonSchema(expenseSchemaBody)
